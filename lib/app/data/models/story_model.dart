...
class Data {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (objective != null) data["objective"] = objective?.toJson();
    ...
    if (postHashTag != null) data["postHashTag"] = postHashTag;
...
class Objective {
  ...
  Objective({this.id, this.hashTag, this.s3IconUrl});
