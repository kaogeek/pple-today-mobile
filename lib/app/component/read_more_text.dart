...
class ReadMoreText extends StatefulWidget {
  ...
  const ReadMoreText(
    this.data, {
    Key? key,
    this.trimExpandedText = ' ดูน้อยลง',
    this.trimCollapsedText = '...อ่านเพิ่มเติม',
...
class ReadMoreTextState extends State<ReadMoreText> {
  ...
  Widget build(BuildContext context) {
    ...
    final colorClickableText = widget.colorClickableText ?? kPrimaryColor;

    TextSpan linkRead = TextSpan(
