...
class RefreshLoadMoreListView extends StatefulWidget {
  ///builder
  const RefreshLoadMoreListView.builder({
    Key? key,
    ...
    this.loadMoreWidget,
    //refresh
    this.refreshBackgroundColor = Colors.white,
    this.refreshDisplacement = 40.0,
    this.refreshEdgeOffset = 0.0,
    this.refreshColor = kPrimaryColor,
  ...
  ///separated
  const RefreshLoadMoreListView.separated({
    Key? key,
    required this.itemBuilder,
  ...
  /// CustomScrollView
  const RefreshLoadMoreListView.customScrollView({
    Key? key,
  ...
  @override
  State<StatefulWidget> createState() => _RefreshLoadMoreListViewState();
}
