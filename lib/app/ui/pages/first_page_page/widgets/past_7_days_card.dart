...
class Past7DaysCard extends GetWidget<FirstPageController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      if ((controller.firstPageModel.value.data?.todayPast7Days ?? []).isEmpty) return const SizedBox();
      ...
      return Column(
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...controller.firstPageModel.value.data!.todayPast7Days!.map(
                  (e) {
                    return Padding(
