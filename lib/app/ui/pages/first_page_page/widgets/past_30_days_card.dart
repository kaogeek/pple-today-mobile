...
class Past30DaysCard extends GetWidget<FirstPageController> {
  const Past30DaysCard({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      if ((controller.firstPageModel.value.data?.todayPast30Days ?? []).isEmpty) return const SizedBox();
      ...
      return Column(
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...controller.firstPageModel.value.data!.todayPast30Days!.map(
                  (e) {
                    return Padding(
