...
class BodyRedeemPointUserPoint extends GetWidget<UserPointController> {
  const BodyRedeemPointUserPoint({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final redeemPointStatement = controller.dataModel.value.data?.accumulatePoint?.redeemPointStatement;
      if ((redeemPointStatement ?? []).isEmpty) {
        return Center(
          child: Text(
            'ไม่มีข้อมูล',
            style: TextStyle(
      ...
      return ListView(
        ...
        children: ListTile.divideTiles(
            context: context,
            tiles: redeemPointStatement!.map((e) {
              return SizedBox(
